<<<<<<< HEAD
# Catalyzt-React-Js-Version
first version of Catalyzt use conventional tech stack(html, css, js, bootstrap). Now in this version We will use React Js with Martial Kit React
=======
